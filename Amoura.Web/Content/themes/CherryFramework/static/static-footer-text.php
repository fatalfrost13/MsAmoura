...
<div id="footer-text" class="footer-text">
	...
	<?php if( is_front_page() ) { ?>
		More Night Club WordPress Templates at <a rel="nofollow" href="http://www.templatemonster.com/category/night-club-wordpress-templates/" target="_blank">TemplateMonster.com</a>
	<?php } ?>
</div>