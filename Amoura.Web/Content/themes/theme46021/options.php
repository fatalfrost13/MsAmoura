...
// Fonts
			...
			$typography_mixed_fonts["Cinzel Decorative, cursive"] = "Cinzel Decorative *";
...
// ---------------------------------------------------------
			...
			$background_defaults = array(
				'color' => '', 
				'image' => get_stylesheet_directory_uri().'/images/body.gif', 
				'repeat' => 'repeat',
				'position' => 'top center',
				'attachment'=>'scroll'
			);
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '21px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#6b6b6b'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '32px', 'lineheight' => '36px', 'face' => 'Cinzel Decorative, cursive', 'style' => 'normal', 'character'  => 'latin', 'color' => '#fdfdfd'));
			...
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '15px', 'lineheight' => '23px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#05abc4'));
								
			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '15px', 'lineheight' => '23px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#fdfdfd'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '48px', 'lineheight' => '42px', 'face' => 'Cinzel Decorative, cursive', 'style' => 'normal', 'character'  => 'latin', 'color' => '#de0062	'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '15px', 'lineheight' => '25px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#6b6b6b'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '18px', 'lineheight' => '25px', 'face' => 'Cinzel Decorative, cursive', 'style' => 'normal', 'character'  => 'latin', 'color' => '#6b6b6b'));
		return $options;
	}
}
?>